 ...
 */
public class PublicKeyListAdapter extends CursorAdapter implements StickyListHeadersAdapter {
    ...
    public PublicKeyListAdapter(Context context, Cursor c, int flags, int sectionColumnIndex) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return mInflater.inflate(R.layout.public_key_list_item, null);
    }
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.public_key_list_header, parent, false);
